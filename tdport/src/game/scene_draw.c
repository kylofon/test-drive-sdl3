...
static u16 cop_row(u16 bp)
{
    if (DSB(DS_r_cop_state) != 3) {
        u16 d = (u16)(DSW(0x1447) - bp);   /* cop_row_smooth */
        if ((s16)d <= 2 && (s16)d >= -2) return DSW(0x1447);
    }
    DSW(0x1447) = bp;
    return bp;
}
...
void draw_road_main(void)
{
    ...
    do {
        ...
        if (!(DSB(DS_dash_counter) & 0x0F)) {
            ...
            if (bx < DSW(DS_xclip_px)) {
                u16 cx = (u8)(cl - (u8)s);
                u16 e = (u16)(((s >> 1) & 0xFC) + 0x0FA7);          /* XROADA pal*, pol* at +0x10 */
        ...
        /* signs 2..8 with post */
        {
            ...
            if (al <= 6) {
                ...
                if (bx < DSW(DS_xclip_px)) {
                    u16 di = (u16)((s & 0xF8) + ax + 0x1043);
                    u16 cx = (u16)((u16)cl - s);
                    u16 post = (u16)(((s >> 1) & 0xFC) + 0x1123);
                ...
                if (bx != 0) {
                    ...
                    if (draw) {
                        ...
                        if (d < DSW(DS_xclip_px)) {
                            ...
                            fs_push_frame(&st, d, ax, (u16)(e + 0x1173), (u16)(e + 0x1177), DSW(DS_xclip_bytes), di);
                        }
                    }
                }
                si = (u16)(si + 8);
        ...
        if (DSB(DS_r_cop_state) != 0 && DSB(DS_r_cop_state) != 7) {
            ...
            if (draw) {
                ...
                if (!((s16)b > (s16)DSW(DS_xclip_px))) {
                    u16 x = b;
                    u16 e = (u16)(scale_entry(cop_row(bp), DS_traffic_scale_main) + 0x132B);
                    u16 y = DSW((u16)(DS_row_sy + bp));
                    u16 cy = DSW(DS_crest_sy);
                    if (bp == 2) { y = 0x76; cy = 0x6F; }
                    if (e == 0x134B)
                        fs_push_frame(&st, x, y, 0x137B, 0x137F, DSW(DS_xclip_bytes), cy);   /* copb / copm */
        ...
        if (DSW(DS_cut_x) < 0x140 && bp == DSW(DS_cut_row)) {
            ...
            fs_push_frame(&st, ax, d, 0x0FA3, 0x0F9F, DSW(DS_xclip_bytes), DSW(DS_crest_sy));  /* clfo / clfa */
        }
    ...
    if (bp == 0x50) {
        ...
        for (int lane = 0; lane < 2; lane++) {
            ...
            if ((u8)cx == 0) continue;
            u16 bx = (u16)(((cx - 1) << 3) + (lane == 0 ? 0x09AD : 0x09D5));
            for (;;) {
                if (!((s16)(u16)(DSW(bx) - si) < 0x27)) {
                    u16 e = DSW((u16)(bx + 6));
                    u16 y = DSB(0x1BC1);                                    /* sy[39] */
                    u16 d = (u16)(DSW((u16)(DS_row_cx + tr))
                                  + (lane == 0 ? DSW((u16)(DS_row_l + tr)) : DSW((u16)(DS_row_r + tr))));
                    d = (u16)((s16)d >> 1);
                    if (d < DSW(DS_xclip_px))
                        fs_push_frame(&st, d, y, (u16)(e + 0x1173), (u16)(e + 0x1177),
    ...
    do {
            ...
            for (;;) {
                ...
                if (bx != 0) {
                    ...
                    if (draw) {
                        ...
                        d = (u16)((s16)d >> 1);
                        if (d < DSW(DS_xclip_px))
                            fs_push_frame(&st, d, ax, (u16)(e + 0x1173), (u16)(e + 0x1177),
                                          DSW(DS_xclip_bytes), DSW(DS_crest_sy));
                    }
                }
                si = (u16)(si + 8);
        ...
        if (DSB(DS_r_cop_state) != 0 && DSB(DS_r_cop_state) != 7) {
            ...
            if (draw) {
                ...
                if (!((s16)b > (s16)DSW(DS_xclip_px))) {
                    u16 x = b;
                    u16 e = (u16)(scale_entry(cop_row(bp), DS_traffic_scale_mirror) + 0x1303);
        ...
        /* mirror horizon cliff */
        {
            ...
            if (!((s16)ax < 0xF0) && (s16)ax < 0x140 && bp == DSW(DS_cut_row_mirror)) {
                ...
                if (!((s16)d < 0xF)) d = 0xF;
                d = (u16)(d + 0x1B);
                fs_push_frame(&st, ax, d, 0x102B, 0x1027, DSW(DS_xclip_bytes), DSW(DS_crest_sy)); /* mcfo / mcfa */
            }
        }
